...
class sudoku:
    ...
    def __init__(self, Number=None):
        ...
        if Number!=None:
            ...
            self.number = int(raw_input('Set the sudoku id: (10xx) '))
    ...
    def read(self):
        ...
        with open(self.filename, "r") as f:
            ...
            for j in range(0, len(record)):
                print "[%d] "%j,
                print f01[record[j]]
            choice = raw_input("which record [x] are you reading? x = ")
...
def sudokuIn():
    puzzleNo = int(raw_input('Set the puzzle number:'))
    puzzleRow1 = raw_input('1st Row:').split(',')
    puzzleRow2 = raw_input('2nd Row:').split(',')
    puzzleRow3 = raw_input('3rd Row:').split(',')
    puzzleRow4 = raw_input('4th Row:').split(',')
    puzzleRow5 = raw_input('5th Row:').split(',')
    puzzleRow6 = raw_input('6th Row:').split(',')
    puzzleRow7 = raw_input('7th Row:').split(',')
    puzzleRow8 = raw_input('8th Row:').split(',')
    puzzleRow9 = raw_input('9th Row:').split(',')
